  ...
  return (
    <div className="rooms-page">
      ...
      <section className="rooms-hero" style={{ backgroundImage: `url(${roomHeroImg})` }}>
        ...
        <div className="floating-widget-wrapper animate-on-scroll fade-up delay-400">
          <div className="search-capsule">
            
            {/* Check In - Check Out */}
            <div className="capsule-item" ref={datePickerRef} onClick={() => setShowDatePicker(!showDatePicker)}>
              <span className="label">Check In - Check Out</span>
              <div className="value-display">
                {dates.checkIn && dates.checkOut ? `${dates.checkIn} to ${dates.checkOut}` : 'Select Dates'}
                <span className="arrow-icon">↓</span>
              </div>
              {showDatePicker && (
                <div className="dropdown-overlay date-picker-dropdown" onClick={(e) => e.stopPropagation()}>
            ...
            {/* Rooms Selector */}
            <div className="capsule-item" ref={roomDropdownRef} onClick={() => setShowRoomDropdown(!showRoomDropdown)}>
              ...
              {showRoomDropdown && (
                <ul className="dropdown-overlay list-dropdown">
                  {roomsData.map((room) => (
                    <li 
                      key={room.id} 
            ...
            {/* Guests Selector */}
            <div className="capsule-item" ref={guestDropdownRef} onClick={() => setShowGuestDropdown(!showGuestDropdown)}>
              ...
              {showGuestDropdown && (
                <ul className="dropdown-overlay list-dropdown">
                  {['1 Guest', '2 Guests', '3 Guests', '4 Guests', '5+ Guests'].map((item) => (
                    <li 
                      key={item} 
                      className={guests === item ? 'active' : ''} 
